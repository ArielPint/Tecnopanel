...
import { useEstadoPagoDetalle } from '../hooks/useEstadoPagoDetalle'
...
interface Props {
  ...
  subcontratoLabel: string
  onCambiarEstado: (id: string, estado: EstadoEP) => Promise<void>
  onRegistrarPago: (id: string, montoPagado: number) => Promise<void>
}
...
export default function DetalleEstadoPago({ estadoPago, subcontratoLabel, onCambiarEstado, onRegistrarPago }: Props) {
  ...
  async function onCambiar(destino: EstadoEP) {
    setCambiandoEstado(true)
    try {
      if (destino === 'pagado') await onRegistrarPago(estadoPago.id, Number(montoPagado) || 0)
        ...
        <div className="flex flex-col gap-5 text-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <p className="font-medium tabular-nums">{formatCLP(estadoPago.monto_pagado)}</p>
            </div>
            <div>
            ...
            <div className="flex flex-col gap-2 rounded-md border p-3">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {estadoPago.estado === 'aprobado' && puedeAprobar && (
                  <MontoInput
                    value={montoPagado ? Number(montoPagado) : null}
                    onChange={(v) => setMontoPagado(v != null ? String(v) : '')}
