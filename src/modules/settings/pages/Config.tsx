    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          ...
          días trabajados, horas extras (columna L), bono de producción (columna M), costo empresa y las cargas
          del empleador que caen sobre esas horas extras y ese bono (prorrateadas por imponible), y alimentan
