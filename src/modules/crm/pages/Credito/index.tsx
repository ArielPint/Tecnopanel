...
export default function Credito(){
  ...
  async function load(){
    ...
    handleSupabaseError(asigsErr,'Credito.load.asignaciones')
    handleSupabaseError(histErr,'Credito.load.historial')
    ...
    if(userIds.length){
      ...
      handleSupabaseError(usersErr,'Credito.load.profiles')
