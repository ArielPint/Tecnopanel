      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            ...
            Configuración desde la planilla de remuneraciones.
          </CardDescription>
        </CardHeader>
      ...
      {d.loading ? (
        ...
        <>
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
            ...
            <Kpi label="$ MOD por m² (último mes)" value={ultimo ? fmtMonto(ultimo.costoM2) : '—'} tono="warning" />
            <Kpi
              label="$ MOD por m² (acumulado)"
              value={fmtMonto(d.totales.costoM2)}
              sub={`${fmtNum(d.totales.meses)} mes(es) cargado(s) · ${fmtNum(d.totales.m2, 1)} m²`}
              tono="success"
            />
          </div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="text-right">$ por m²</TableHead>
